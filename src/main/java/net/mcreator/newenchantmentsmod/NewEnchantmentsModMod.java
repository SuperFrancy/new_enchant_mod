package net.mcreator.newenchantmentsmod;
...
@Mod("new_enchantments_mod")
public class NewEnchantmentsModMod {
	public static final Logger LOGGER = LogManager.getLogger(NewEnchantmentsModMod.class);
	public static final String MODID = "new_enchantments_mod";

	public NewEnchantmentsModMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		NewEnchantmentsModModEnchantments.REGISTRY.register(modEventBus);
